...
export default function SupExportModalScreen() {
  return (
    <SafeAreaScreen header={<AppHeader subtitle="Ban Giám Sát" />}>
      <Card style={styles.card}>
        <Text style={[typography.titleMd, styles.title]}>M-SUP-05: Xuất Hồ sơ Báo cáo PDF/ZIP</Text>
        ...
        <Text style={[typography.caption, styles.detail]}>
          Cấu hình xuất báo cáo kỹ thuật PDF hoặc gói dữ liệu bằng chứng ZIP.
        </Text>
      </Card>
    </SafeAreaScreen>
  );
