...
export default function SupHomeScreen() {
  return (
    <SafeAreaScreen header={<AppHeader subtitle="Ban Giám Sát" />}>
      <Card style={styles.card}>
        <Text style={[typography.titleMd, styles.title]}>M-SUP-01: Dashboard Giám sát viên</Text>
        ...
        <Text style={[typography.caption, styles.detail]}>
          Tổng quan rủi ro mạng lưới đường, danh sách hồ sơ đợt sửa cần phê duyệt.
        </Text>
      </Card>
    </SafeAreaScreen>
  );
