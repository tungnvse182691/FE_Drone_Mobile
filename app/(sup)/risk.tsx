...
export default function SupRiskScreen() {
  return (
    <SafeAreaScreen header={<AppHeader subtitle="Ban Giám Sát" />}>
      <Card style={styles.card}>
        <Text style={[typography.titleMd, styles.title]}>M-SUP-03: Tổng quan rủi ro tuyến đường</Text>
        ...
        <Text style={[typography.caption, styles.detail]}>
          Theo dõi 6 tuyến đường trọng điểm, danh sách điểm đen nguy cơ lún sụt.
        </Text>
      </Card>
    </SafeAreaScreen>
  );
