  ...
  return (
    <SafeAreaScreen header={<AppHeader subtitle="Phi công Drone" />}>
      <Card style={styles.card}>
        <Text style={[typography.titleMd, styles.title]}>M-DRONE-01: Tổng quan Drone (Dashboard)</Text>
        ...
        <Text style={[typography.caption, styles.detail]}>
          Dashboard hiển thị thông tin phi công, trạng thái thiết bị và yêu cầu bay mới.
        </Text>
      </Card>
    </SafeAreaScreen>
  );
