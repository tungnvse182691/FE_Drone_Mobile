...
const REQUEST_DETAILS: Record<string, RequestDetailData> = {
  '#REQ-KS-089': {
    code: '#REQ-KS-089',
    roadTitle: 'Đoạn ĐT.741 - Cầu Sông Bé',
    location: 'Km12 - Km14, Xã Phước Hòa, Phú Giáo, Bình Dương',
    statusText: 'MỚI TIẾP NHẬN',
    length: '3.5 km',
    altitude: '45 m (AGL)',
    overlap: '80% / 70%',
    format: '4K 60fps + RTK',
    coordinates: '11.2312° N, 106.8214° E',
    corridorTitle: 'LƯU VỰC SÔNG BÉ',
    roadName: 'ĐT.741 (Km12 - Km14)',
    targetPoint: 'Điểm sạt trượt taluy âm',
    pmName: 'Trần Hoàng Quân (PM)',
    instructionTime: 'Hôm nay, 08:30',
    instructionQuote:
      '“Khảo sát đoạn từ Km12 đến Km14. Chú ý quét kỹ khu vực mép taluy âm gần trụ cầu Sông Bé đang có dấu hiệu sạt trượt sau mưa lớn. Cần bay ở độ cao 45m và quét LiDAR 2 lượt.”',
    priority: 'Khẩn cấp',
  },
  '#REQ-KS-090': {
    code: '#REQ-KS-090',
    roadTitle: 'Quốc lộ 1A - Km 1842+150',
    location: 'Km 1840 - Km 1843, Trảng Bom, Đồng Nai',
    statusText: 'MỚI TIẾP NHẬN',
    length: '2.4 km',
    altitude: '35 m (AGL)',
    overlap: '85% / 75%',
    format: '4K 60fps + RTK',
    coordinates: '10.9572° N, 107.0124° E',
    corridorTitle: 'TRỤC HUYẾT MẠCH QL.1A',
    roadName: 'QL.1A (Km1840 - Km1843)',
    targetPoint: 'Vệt lún sâu & nứt bê tông nhựa',
  ...
  '#REQ-KS-088': {
    code: '#REQ-KS-088',
    roadTitle: 'Đường Vành đai 3 - Gói XL-02',
    location: 'Km22 - Km26, TP. Thủ Đức, TP.HCM',
    statusText: 'MỚI TIẾP NHẬN',
    length: '4.0 km',
    altitude: '50 m (AGL)',
    overlap: '80% / 70%',
    format: '4K 60fps + RTK',
    coordinates: '10.8431° N, 106.7925° E',
    corridorTitle: 'HÀNH LANG VÀNH ĐAI 3',
    roadName: 'Vành đai 3 (Km22 - Km26)',
    targetPoint: 'Khe co giãn dầm cầu cạn',
    pmName: 'Nguyễn Thùy Lan (PM)',
    instructionTime: 'Hôm qua, 16:15',
    instructionQuote:
      '“Quét ảnh trực giao 3D độ phân giải cao phục vụ đo lường tiến độ và xuất mô hình bề mặt DSM. Kiểm tra kỹ 2 mố dầm tiếp giáp sông Đồng Nai.”',
    priority: 'Tiêu chuẩn',
  },
  '#REQ-KS-087': {
    code: '#REQ-KS-087',
    roadTitle: 'Cao tốc Phan Thiết - Dầu Giây',
    location: 'Nút giao Cẩm Mỹ, Đồng Nai',
    statusText: 'ĐANG THỰC HIỆN',
    length: '5.2 km',
    altitude: '45 m (AGL)',
    overlap: '80% / 70%',
    format: '4K 60fps + RTK',
    coordinates: '10.9821° N, 107.2140° E',
    corridorTitle: 'NÚT GIAO CAO TỐC CẨM MỸ',
    roadName: 'Cao tốc CT.01 (Nút Cẩm Mỹ)',
    targetPoint: 'Đoạn lề taluy dương',
    pmName: 'Trần Văn Nam (PM)',
    instructionTime: 'Hôm nay, 06:30',
    instructionQuote:
      '“Bay quét toàn bộ nút giao hình hoa thị, chú ý điểm tiếp giáp đường dẫn cao tốc và trạm thu phí.”',
    priority: 'Đang bay',
  },
  '#REQ-KS-085': {
    code: '#REQ-KS-085',
    roadTitle: 'Tỉnh lộ 769 - Cầu Suối Cả',
    location: 'Km08 - Km11, Huyện Long Thành, Đồng Nai',
    statusText: 'ĐÃ HOÀN THÀNH BAY',
    length: '3.1 km',
    altitude: '40 m (AGL)',
    overlap: '80% / 70%',
    format: '4K 60fps + RTK',
    coordinates: '10.7854° N, 106.9942° E',
    corridorTitle: 'CẦU SUỐI CẢ - ĐƯỜNG 769',
    roadName: 'Tỉnh lộ 769 (Km08 - Km11)',
