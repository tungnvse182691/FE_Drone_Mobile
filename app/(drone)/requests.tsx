...
const REQUESTS_DATA: SurveyRequest[] = [
  {
    ...
    title: 'Đoạn ĐT.741 - Cầu Sông Bé Km14+250',
    location: 'Xã Phước Hòa, Phú Giáo, Bình Dương',
    note: 'Ghi chú: Khảo sát lún nứt taluy và sạt lở mép đường',
    status: 'new',
  ...
  },
  {
    ...
    title: 'Quốc lộ 1A - Km 1842+150',
    location: 'Trảng Bom, Đồng Nai',
    note: 'Kiểm tra lún nứt mặt bê tông nhựa • 2.4 km',
    status: 'new',
    statusLabel: 'MỚI',
    tab: 'pending',
  },
  {
    ...
    title: 'Cao tốc Phan Thiết - Dầu Giây',
  ...
  },
  {
    ...
    title: 'Đường Vành đai 3 - Gói thầu XL-02',
    location: 'TP. Thủ Đức, TP.HCM',
    note: 'Ghi chú: Đoạn khe co giãn dầm cầu nứt vỡ',
    status: 'new',
    statusLabel: 'MỚI',
    tab: 'pending',
  },
  {
    ...
    code: '#REQ-KS-085',
    timeAgo: '20/10/2023',
    title: 'Tỉnh lộ 769 - Cầu Suối Cả',
    location: 'Huyện Long Thành, Đồng Nai',
    note: 'Video 4K đã tải lên máy chủ đối soát',
    status: 'uploaded',
