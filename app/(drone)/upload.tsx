...
> = {
  '#REQ-KS-089': {
    code: '#REQ-KS-089',
    road: 'Đoạn ĐT.741 - Cầu Sông Bé',
    videoName: 'DJI_0482_SURVEY_DT741.MP4',
    videoSize: '184.2 MB',
    srtName: 'DJI_0482_SURVEY_DT741.SRT',
    srtSize: '420 KB',
    sha256: '7f8a3c4b92d1...e4b1 (Khớp 100%, toàn vẹn)',
    gpsCoord: '11.1824° B, 106.8291° Đ (Sai số ±1.2m)',
    gpsAddress: 'Đoạn ĐT.741, xã Tân Lập, Huyện Đồng Phú, Bình Phước',
  },
  '#REQ-KS-090': {
    code: '#REQ-KS-090',
    road: 'Quốc lộ 1A - Km 1842+150',
    videoName: 'DJI_0490_SURVEY_QL1A.MP4',
    videoSize: '195.4 MB',
    srtName: 'DJI_0490_SURVEY_QL1A.SRT',
    srtSize: '380 KB',
    sha256: '9b2c3d4e5f6a...77c2 (Khớp 100%, toàn vẹn)',
    gpsCoord: '10.9572° B, 107.0124° Đ (Sai số ±1.1m)',
    gpsAddress: 'QL.1A, Thị trấn Trảng Bom, Tỉnh Đồng Nai',
  },
  '#REQ-KS-088': {
    code: '#REQ-KS-088',
    road: 'Đường Vành đai 3 - Gói XL-02',
    videoName: 'DJI_0488_SURVEY_VD3.MP4',
    videoSize: '210.0 MB',
    srtName: 'DJI_0488_SURVEY_VD3.SRT',
    srtSize: '512 KB',
    sha256: '4a5b6c7d8e9f...12a4 (Khớp 100%, toàn vẹn)',
    gpsCoord: '10.8431° B, 106.7925° Đ (Sai số ±0.9m)',
    gpsAddress: 'Đường Vành đai 3, TP. Thủ Đức, TP. Hồ Chí Minh',
  },
  '#REQ-KS-087': {
    code: '#REQ-KS-087',
    road: 'Cao tốc Phan Thiết - Dầu Giây',
    videoName: 'DJI_0487_SURVEY_PTDG.MP4',
    videoSize: '240.5 MB',
    srtName: 'DJI_0487_SURVEY_PTDG.SRT',
    srtSize: '620 KB',
    sha256: '1e2f3a4b5c6d...99b0 (Khớp 100%, toàn vẹn)',
    gpsCoord: '10.9821° B, 107.2140° Đ (Sai số ±1.4m)',
    gpsAddress: 'Nút giao Cẩm Mỹ, Cao tốc Phan Thiết - Dầu Giây, Đồng Nai',
  },
  '#REQ-KS-085': {
    code: '#REQ-KS-085',
    road: 'Tỉnh lộ 769 - Cầu Suối Cả',
    videoName: 'DJI_0485_SURVEY_TL769.MP4',
    videoSize: '165.8 MB',
    srtName: 'DJI_0485_SURVEY_TL769.SRT',
    srtSize: '310 KB',
    sha256: '3c4d5e6f7a8b...44d9 (Khớp 100%, toàn vẹn)',
    gpsCoord: '10.7854° B, 106.9942° Đ (Sai số ±1.0m)',
    gpsAddress: 'Km08+950 Tỉnh lộ 769, Huyện Long Thành, Đồng Nai',
  },
};
